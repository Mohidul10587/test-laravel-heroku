...
<head>
    ...
    <!--bootstrap-->
    <link rel="stylesheet" href="{{ asset('panel/assets/css/bootstrap.min.cs')}}s">
    <!--font awesome-->
        ...
        <div class="content_wrapper">
            ...
            <div class="login_page center_container">
                <div class="center_content">
                    ...
                    <div class="ml-2 mr-2 alert alert-warning alert-dismissible fade show" role="alert">
                    ...
                    <form action=" {{route('admin.login')}}" class="d-block" method="post">
                        ...
                        <div class="form-group icon_parent">
                            ...
                            <input  type="email" class="form-control" name="email" autofocus placeholder="Email Address">
