    ...
    <div class="middle_content_wrapper">
        ...
        <form action="posted-jobs-data" method="post">
            ...
            <div style="display: flex; justify-content:center">
                ...
                <div style="width:650px; display: flex; justify-content:space-between">
                    <div>
                        ...
                        <input
                            style="width: 300px;  height:40px;  border:1px solid gray; border-radius:5px; padding-left:5px; "
                            type="text"  name="folder_name" required> <br>
                        <p style="text-align: center; font-weight:bolder; margin-bottom:-3px; margin-top:10px"><label for="deadline_date">Job Id</label><br></p>
                        <input
                            style="width: 300px;  height:40px;  border:1px solid gray; border-radius:5px; padding-left:5px; "
                            type="number"  name="job_id" required><br>
                        ...
                        <input
                            style="width: 300px;  height:40px;  border:1px solid gray; border-radius:5px; padding-left:5px; "
                            type="text" name="job_type" required><br>
                        ...
                        <textarea style="width: 300px;  height:40px;  border:1px solid gray; border-radius:5px "
                            type="text"  name="instruction" required></textarea><br>
                        ...
                        <input
                            style="width: 300px;  height:40px;  border:1px solid gray; border-radius:5px; padding-left:5px;"
                            type="number"  name="total_image" required> <br>
                    ...
                    <div>
                        ...
                        <input
                            style="width: 300px;  height:40px;  border:1px solid gray; border-radius:5px; padding-left:5px; "
                            type="url"  name="goole_drive_link" required><br>
                        ...
                        <input
                            style="width: 300px;  height:40px;  border:1px solid gray; border-radius:5px; padding-left:5px; "
                            type="date" id='deadline_date' name="deadline_date" required><br>
                        ...
                        <input
                            style="width: 300px; height:40px;  border:1px solid gray; border-radius:5px; padding-left:5px; "
                            type="time" id='deadline_time'name="deadline_time" required>
                        <p style="text-align: center; font-weight:bolder; margin-bottom:-3px; margin-top:18px"><label  for="empoyee_name">Assign to..</label></p>
                        <select style="width: 300px;  height:40px; border:1px solid gray; border-radius:5px "
                            name="empoyee_name" id="empoyee_name" required>
            ...
            <div style="display:flex;justify-content:center">
                ...
                <button style="width: 300px;  height:40px; margin-top: 30px; border:1px solid gray; border-radius:5px ; background-color:white;"
